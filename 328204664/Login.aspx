<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="_328204664.Login" %>
...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Fname], [Lname], [Password], [Email] FROM [Record]"></asp:SqlDataSource>
</body>
</html>
